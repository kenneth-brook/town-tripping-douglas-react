...
import '../sass/componentsass/Stay.scss'; // Import the SCSS file with the correct path
...
const Stay = ({ pageTitle }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://8pz5kzj96d.execute-api.us-east-1.amazonaws.com/Prod/data/stay');
        if (!response.ok) {
